            ...
            >
                <span class="member-name">
                    {{ balance.member_name
                        ...
                        v-if="balance.member_id === currentMemberId"
                        class="you-indicator"
                    >
                        (You)</span
                    >
                ...
                <ion-label>
                    <h2>
                        {{ settlement.from_member_name
                            ...
                            v-if="settlement.from_member_id === currentMemberId"
                            class="you-indicator"
                        >
                            (You)</span
                        >
                        ...
                        {{ settlement.to_member_name
                            ...
                            v-if="settlement.to_member_id === currentMemberId"
                            class="you-indicator"
                        >
                            (You)</span
                        >
...
const mySettlements = computed(() => {
    ...
    return props.settlements.filter(
        (s) =>
            s.from_member_id === props.currentMemberId ||
            s.to_member_id === props.currentMemberId,
    );
});
